...
# List of quiz questions in English (Intermediate Level)
questions = [
    {
    ...
    },
    {
        ...
        "options": {
            "a": "I never exercise.",  
            "b": "I am going to exercise tomorrow.",  
            "c": "I exercised last month.",  
    ...
    },
    {
        ...
        "options": {
            "a": "I want to travel.",  
            "b": "I go to the beach.",  
            "c": "I went there last year.",  
            "d": "I am planning my next trip."  
        },
        "correct": "b"
    },
    {
        ...
        "options": {
            ...
            "b": "I am learning to play an instrument.",  
            "c": "I don't listen to music.",  
            "d": "I will go to a concert soon."  
        },
        "correct": "a"
    }
]
...
def open_learning_page():
    os.system("python session_eng_inter.py")
