...
questions = [
    {
        "question": "¿Qué harías si ganaras la lotería?", #(What did you do last weekend?)
        "options": {
            "a": "Compré una casa el año pasado.",   #(I went to the movies with my friends.)
            "b": "Viajaría por el mundo.",  #I ate at home every day.)
            "c": "Estoy trabajando ahora mismo.",  #(I am studying for an exam.)
            "d": "Voy a comprar comida."  #(I will go shopping tomorrow.)
        },
        "correct": "b"
    },
    {
        "question": "¿Qué has hecho para prepararte para la presentación?", #(When does the Spanish class start?) 
        "options": {
            "a": "He estudiado los informes.",  #(It started yesterday.)
            "b": "Estaré preparado mañana.",  #(It starts at 2 p.m.)
            "c": "Voy al supermercado.",  #(It ends at 5.)
            "d": "Estoy en la oficina ahora."  #(I am at home now.)
        },
        "correct": "a"
    },
    {
        "question": "¿Por qué no viniste a la reunión de ayer?", #(What do you need to cook an omelette?)
        "options": {
            "a": "Porque no estaba en la ciudad.",  #(A book and a magazine.)
            "b": "Voy a ir mañana.", #(Eggs and oil.)
            "c": "Me gusta el fútbol.",  #(A pen and a notebook.)
            "d": "Estoy trabajando en casa."  #(A computer.)
        },
        "correct": "a"
    },
    {
        "question": "¿Cómo resolviste el problema en el trabajo?", #(Where is the nearest bank?)
        "options": {
            "a": "Me gusta mi trabajo mucho.",  #(It’s on the corner of the street.)
            "b": "Estoy buscando una solución ahora.",  #(I’m going to the bank tomorrow.)
            "c": "Hablé con mi jefe y encontramos una solución. ",  #(I like Spanish food.)
            "d": "Resolveré el problema mañana."  #(The bank is big.)
        },
        "correct": "c"
    },
    {
        "question": "¿Qué opinas sobre las nuevas políticas de la empresa?", #(How was the movie you watched?)
        "options": {
            "a": "Me gusta ir al cine.",  #(It was very boring.)
            "b": "Están preparando una fiesta.",  #(It will be interesting.)
            "c": "Creo que son muy útiles.",  #(I am studying.)
            "d": "Estoy buscando mi teléfono."  #(I’m going to the movies later.)
        },
        "correct": "c"
    }
]
...
def open_learning_page():
    os.system("python session_esp_adv.py") 
